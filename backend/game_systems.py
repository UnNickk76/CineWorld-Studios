...
INFRASTRUCTURE_TYPES = {
    ...
    'talent_scout_actors': {
        ...
        'name': 'Talent Scout Agency',
        'name_it': 'Agenzia Talent Scout',
        'description': 'Unified Talent Scout agency that recruits actors, directors, composers and illustrators',
        'description_it': 'Agenzia unica che scopre nuovi talenti: attori, registi, compositori e disegnatori. Le quote per ruolo sono distribuite in base al livello dell\'infra.',
        'level_required': 10,
        'fame_required': 25,
        'base_cost': 500000,
        'screens': 0,
