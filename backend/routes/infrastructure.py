...
INFRA_LEVEL_PERKS = {
    'production_studio': {
        1: ['1 progetto film classico in parallelo', 'Cooldown classico 5 giorni', '1 progetto LAMPO film, cooldown 24h'],
        3: ['2 progetti classici paralleli'],
        5: ['Sblocca Live Action (con Player Lv 10 + Fama 100)'],
        6: ['3 progetti classici paralleli', 'Cooldown classico ridotto a 3 giorni', '2 progetti LAMPO paralleli, cooldown 6h'],
        9: ['5 progetti classici paralleli', 'Cooldown classico 2 giorni', '3 progetti LAMPO paralleli, cooldown 3h'],
        15: ['8 progetti classici paralleli', 'Cooldown classico 1 giorno', '4 LAMPO paralleli'],
        25: ['12 progetti classici paralleli', 'Cooldown classico 12h', '6 LAMPO paralleli'],
        50: ['20 progetti classici paralleli', 'Cooldown classico 6h', '10 LAMPO paralleli'],
        100: ['40 progetti classici paralleli', 'Cooldown 1h', '20 LAMPO paralleli'],
        200: ['Progetti classici e LAMPO illimitati, nessun cooldown'],
    },
    'studio_serie_tv': {
        1: ['1 serie TV in parallelo', 'Cooldown 5 giorni', '1 LAMPO serie TV cooldown 24h'],
        3: ['2 serie TV parallele'],
        6: ['3 serie TV parallele', 'Cooldown 3 giorni', '2 LAMPO serie parallele'],
        9: ['5 serie TV parallele', 'Cooldown 2 giorni', '3 LAMPO serie parallele'],
        15: ['8 serie parallele, cooldown 1 giorno'],
        25: ['12 serie parallele, cooldown 12h'],
        50: ['20 serie parallele, cooldown 6h'],
        200: ['Serie illimitate, nessun cooldown'],
    },
    'studio_anime': {
        1: ['1 anime in parallelo', 'Cooldown 5 giorni', '1 LAMPO anime cooldown 24h'],
        3: ['2 anime paralleli'],
        5: ['Sblocca Live Action (con Player Lv 10 + Fama 100)'],
        6: ['3 anime paralleli', 'Cooldown 3 giorni', '2 LAMPO anime paralleli'],
        9: ['5 anime paralleli, cooldown 2 giorni'],
        15: ['8 anime paralleli, cooldown 1 giorno'],
        25: ['12 anime paralleli, cooldown 12h'],
        50: ['20 anime paralleli, cooldown 6h'],
        200: ['Anime illimitati, nessun cooldown'],
    },
    'cinema_school': {
