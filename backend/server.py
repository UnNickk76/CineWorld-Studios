...
# Import shared constants and helpers from server_utils
from server_utils import (
    NAMES_BY_NATIONALITY, NATIONALITIES, STUDIO_COUNTRIES, COUNTRY_NAMES,
    COUNTRY_TO_CONTINENT, DISTRIBUTION_ZONES, FAME_CATEGORIES,
    get_fame_category, calculate_cost_by_fame, generate_default_avatar,
